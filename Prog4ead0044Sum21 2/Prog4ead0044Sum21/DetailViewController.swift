...
class DetailViewController: UIViewController {
    ...
    func configureView() {
        ...
        itemTitleTextField.text = masterController.objectAndDescription[masterController.selectedItem]["Title"]
        itemDescriptionTextView.text = masterController.objectAndDescription[masterController.selectedItem]["Detail"]
    }
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        //masterController.objectsDescription[masterController.selectedItem] = itemDescriptionTextView!.text!
            masterController.objectAndDescription[masterController.selectedItem]["Title"] = itemTitleTextField!.text!
            masterController.objectAndDescription[masterController.selectedItem]["Detail"] = itemDescriptionTextView!.text!
        }
    }
